...
def call(Map parameters = [:], body) {
    ...
    def gradleImage = parameters.get('gradleImage', 'gradle:4.2-jre-alpine')
    ...
    podTemplate(label: label, inheritFrom: "${inheritFrom}",
            containers: [
                [name: 'gradle', image: "${gradleImage}", command: '/bin/sh -c', args: 'cat', ttyEnabled: true, workingDir: '/home/gradle'],
